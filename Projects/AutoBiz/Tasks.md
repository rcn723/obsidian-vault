...
- [x] Submit Etsy developer application — DONE: approved 2026-07-02 (app `welra-shop-report`), integration LIVE end-to-end same day [owner:: ryan] [priority:: high] [status:: done]
