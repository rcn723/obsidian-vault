---
title: AutoBiz Tasks — Archived Build Plan (2026-06)
project: AutoBiz
type: archive
archived: true
updated: 2026-07-10
...
# AutoBiz Tasks — ARCHIVED build plan (superseded 2026-07-10)

> **This file is history, not a queue.** The Welra product this plan described was fully built and deployed (see [[Projects/Welra/State]]); GR3NB LLC formation completed June 2026. Checkboxes are neutralized (◻/✅) on purpose so Dataview task queries skip them. The few genuinely-open items were carried into [[Projects/AutoBiz/Tasks]] and [[_RYAN_TODO]].

---

## Phase 0 — Pre-Build (Ryan — Before Writing Code)

- ✅ Register gr3nb.com domain — registered ✅ [owner:: ryan] [priority:: high] [status:: done]
- ✅ Save gr3nb.com domain receipt → ~/Documents/GR3NB/Tax/2026/Receipts/Formation/ — PDF filed ✅ [owner:: ryan] [priority:: high] [status:: done]
- ✅ File GR3NB LLC in Oregon at sos.oregon.gov ($100 — act as own registered agent) — **APPROVED** ✅ 2026-06-01 · Registry #258223198 [owner:: ryan] [priority:: high] [status:: done]
...
- ✅ File DBA "Welra" as Assumed Business Name at Oregon SOS (~$50) — **APPROVED** ✅ 2026-06-05 · Registry #258497594 [owner:: ryan] [priority:: high] [status:: done]
- ✅ File DBA "Rust & Rainbow" as Assumed Business Name at Oregon SOS (~$50) — **APPROVED** ✅ 2026-06-05 · Registry #258496893 [owner:: ryan] [priority:: high] [status:: done]
- ✅ Save both DBA confirmation PDFs → ~/Documents/GR3NB/Legal/ ✅ 2026-06-05 (DBA_Welra_2026.pdf + DBA_Rust_and_Rainbow_2026.pdf) [owner:: ryan] [priority:: high] [status:: done]
- ✅ Apply for EIN at IRS.gov (free, 15 min) — EIN: 42-2858110 ✅ 2026-05-30 [owner:: ryan] [priority:: high] [status:: done]
- ✅ Print/screenshot EIN confirmation page immediately → ~/Documents/GR3NB/Legal/EIN_Confirmation_GR3NB_LLC.pdf ✅ 2026-05-30 [owner:: ryan] [priority:: high] [status:: done]
- ✅ Add EIN to ~/Documents/GR3NB/README.md (top line) ✅ 2026-05-30 [owner:: claude] [priority:: high] [status:: done]
- ✅ Submit Etsy developer application — DONE: approved 2026-07-02 (app `welra-shop-report`), integration LIVE end-to-end same day [owner:: ryan] [priority:: high] [status:: done]
- ◻ Submit Shopify Partner application at partners.shopify.com — tracked with steps in [[_RYAN_TODO]] #5 [owner:: ryan] [priority:: high] [status:: open]
- ✅ Open Mercury Bank account (mercury.com) — **APPROVED** ✅ 2026-06-04 · confirmation saved to Legal/Mercury_Account_Opening_2026.pdf [owner:: ryan] [priority:: high] [status:: done]
- ✅ Generate Privacy Policy via Termly — published 2026-06-05 ✅ [owner:: ryan] [priority:: high] [status:: done]
- ✅ Generate Terms of Service via Termly — published 2026-06-05 ✅ [owner:: ryan] [priority:: high] [status:: done]
- ✅ Generate DPA — custom written (Termly doesn't offer DPA) — saved as Welra_DPA.md ✅ 2026-06-05 [owner:: claude] [priority:: high] [status:: done]
- ✅ Save all 3 legal documents → ~/Documents/GR3NB/Legal/ ✅ 2026-06-05 (privacy_policy.html, terms_of_service.html, cookie_policy.html, Welra_DPA.md) [owner:: ryan] [priority:: high] [status:: done]
- ✅ Save Termly receipt → Tax/2026/Receipts/Services/ ✅ 2026-06-05 (termly-pro-plus-2026-06.pdf · $16 paid) [owner:: ryan] [priority:: medium] [status:: done]
- ✅ Create Operating Agreement — drafted by Claude ✅ 2026-06-05 · saved to Legal/Operating_Agreement_GR3NB_LLC_2026.md [owner:: claude] [priority:: medium] [status:: done]
...
- ✅ Choose SaaS product brand name (DBA under GR3NB) — **Welra**, welra.io registered [owner:: ryan] [priority:: high] [status:: done]
- ✅ Save welra.io domain receipt → Tax/2026/Receipts/Formation/ — PDF filed ✅ [owner:: ryan] [priority:: high] [status:: done]
...
- ✅ Create project at supabase.com (free tier is fine) ✅ 2026-06-06 · project ID: ozhekoiehpajeytwltrv [owner:: ryan] [priority:: high] [status:: done]
- ✅ In Supabase Dashboard → SQL Editor → paste contents of `apps/api/src/lib/db/schema.sql` → Run ✅ 2026-06-06 [owner:: ryan] [priority:: high] [status:: done]
- ✅ In Supabase Dashboard → Storage → Create bucket named `reports` (private, 10MB limit) ✅ 2026-06-06 [owner:: ryan] [priority:: high] [status:: done]
- ✅ Copy `SUPABASE_URL` and `SUPABASE_SERVICE_ROLE_KEY` from Project Settings → API → add to `apps/api/.env` ✅ 2026-06-06 [owner:: claude] [priority:: high] [status:: done]
- ✅ Copy `NEXT_PUBLIC_SUPABASE_URL` and `NEXT_PUBLIC_SUPABASE_ANON_KEY` → add to `apps/web/.env.local` ✅ 2026-06-06 [owner:: claude] [priority:: high] [status:: done]
...
- ✅ Create account at resend.com (free tier: 3k emails/mo) ✅ 2026-06-06 [owner:: ryan] [priority:: high] [status:: done]
- ✅ Add and verify domain: welra.io (add DNS TXT records in Namecheap) ✅ 2026-06-06 · DKIM live, SPF propagating [owner:: ryan] [priority:: high] [status:: done]
- ✅ Copy API key → add `RESEND_API_KEY` to `apps/api/.env` ✅ 2026-06-06 [owner:: claude] [priority:: high] [status:: done]
- ◻ Send test email to confirm welra.io domain is verified [owner:: ryan] [priority:: high] [status:: open]

### Anthropic API Key
- ✅ Go to console.anthropic.com → API Keys → Create key ✅ 2026-06-06 [owner:: ryan] [priority:: high] [status:: done]
- ✅ Add `ANTHROPIC_API_KEY` to `apps/api/.env` ✅ 2026-06-06 [owner:: claude] [priority:: high] [status:: done]
- ✅ Set `REPORT_DRY_RUN=true` initially — set to `false` only when ready to send real emails ✅ pre-set in .env [owner:: claude] [priority:: high] [status:: done]

### Git Setup
- ◻ Create GitHub repo: `welra` (private) [owner:: ryan] [priority:: medium] [status:: open]
- ✅ `git init && git add . && git commit -m "Initial scaffold"` ✅ 2026-06-06 · 38 files committed on main [owner:: claude] [priority:: medium] [status:: done]
...
- ✅ Decide: 'growth' vs 'multi' tier naming — RESOLVED 2026-06-09: **'growth'** everywhere. Code, Stripe products, pricing page already use it; Business_Plan.md and State.md updated to match. [owner:: ryan] [priority:: high] [status:: done]
- ✅ Fix Welra anomaly detector false-positive: zero-revenue check now only fires when revenue drops FROM positive to $0 (not for stores that always had $0). Fixed 2026-06-07. [owner:: claude] [priority:: high] [status:: done]
