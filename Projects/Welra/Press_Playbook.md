---
title: Welra Press Playbook — Ryan's deliverables, scripts & steps
project: Welra
type: playbook
updated: 2026-06-11
tags: [welra, marketing, press, pr, playbook]
---

# Welra Press Playbook — your deliverables
...
## Deliverable 1 — Source-request profiles (do once, ~45 min total)

**What:** journalists post "I need a source who…" requests; you answer; you get quoted + a backlink. HARO is dead — these are the working replacements.
...
**Friday workflow (15 min per response, max 3/week):**
- Skim requests; answer ONLY where you have a real opinion or first-hand experience. One sharp answer beats five generic ones.
- **Response template:**
  > [Direct answer to their exact question in 2–3 sentences — lead with the most quotable line.]
  >
...
- **Worked example** (request: "How do small sellers know if a slow week is a problem?"):
  ...
  >
  > In my own shop, a 20% revenue dip with a steady order count turned out to be a product-mix shift, not a traffic problem — I'd have wasted money on ads if I'd guessed.
  >
  > Ryan Northam, founder of Welra (welra.io)…
- Log any pickup in the campaign metrics table.

---

## Deliverable 2 — Podcast guesting (1 pitch/week)

**Target list (verify each show is still active + has recent episodes before pitching — podcasts die quietly):**

| # | Show | Audience | Angle to lead with |
|---|---|---|---|
| 1 | How to Sell Your Stuff on Etsy (Lizzie Smiley) | Etsy sellers | "The 5 numbers in your stats that actually matter" |
| 2 | Etsy Conversations Podcast | Etsy sellers | Seller-who-built-a-tool story |
| 3 | The Product Boss | Product-based small biz | Multi-channel selling without drowning in data |
| 4 | eCommerce Badassery | Solo e-commerce sellers | Reading your numbers in 10 min/week |
| 5 | Brand Your Passion (Hollie Arnett) | Makers/artists | Numbers for creatives who hate numbers |
| 6 | The Side Hustle Show (Nick Loper) | Side hustlers | Built a SaaS while running a shop |
| 7 | Startups for the Rest of Us (Rob Walling) | Bootstrappers | Niche SaaS for sellers; the Etsy API saga (post-approval only!) |
| 8 | Indie Hackers Podcast | Indie founders | Build-in-public journey |
| 9 | Craft Industry Alliance podcast | Professional makers | Treating a craft shop like a business |
| 10 | A smaller/newer Etsy-niche show you find on Spotify | Etsy sellers | Easiest "yes" — pitch them first to warm up |
...
> - [One topic specific to their recent episodes — reference a real episode]
> - What I learned building a software product while still packing orders
>
> No pitch-fest — happy to make it 90% tactics, 10% my story. One-pager: welra.io/press
>
> Ryan Northam · welra.io · [your phone]

**Rules:** one personalized pitch a week (reference a real recent episode — this is what gets replies). Follow up ONCE after 7–10 days ("floating this back up — happy to work around your calendar"). Then let it go.

**Appearance outline (your talking-points skeleton, ~30–45 min show):**
...
## Deliverable 3 — BetaList listing (~20 min, do this week)

**Steps:** betalist.com → Submit startup → free tier (free takes weeks to publish — fine; we're in beta anyway). Use ryan@welra.io.
...
## Deliverable 4 — Dashboard-hours survey (~30 min setup, runs during beta recruitment)

**Why:** original data = the strongest press magnet. ⚠️ Survey + your own shop's data ONLY — never customer/cross-shop data.

**Steps:** create a Google Form titled **"The 5-minute seller analytics survey"** (your Google account; anonymous, no email required — add an optional "want the results?" email field at the end). Post it in the same Reddit/FB groups during beta recruitment ("doing a quick study, will share results"), to the waitlist, and to beta users in week 2 (alongside the Van Westendorp pricing questions already planned).

**The questions (verbatim):**
1. Which platforms do you sell on? *(checkboxes: Etsy / Shopify / WooCommerce / Amazon / TikTok Shop / Square / In-person / Other)*
2. Roughly how many hours per WEEK do you spend looking at stats/analytics across all of them? *(0 / under 1 / 1–2 / 3–5 / 6–10 / more than 10)*
3. How often do you check your numbers and come away unsure what to actually DO? *(never / sometimes / about half the time / usually / always)*
4. Have you ever stopped checking your stats entirely for a month or more? *(yes / no)*
5. What's your monthly revenue range, all channels combined? *(under $1k / $1–5k / $5–20k / $20–50k / over $50k)*
6. In one sentence: what's the most confusing thing about your shop's numbers? *(open text — this question writes the press story's quotes for us)*

**Target n≥100.** At ~50+ responses Claude drafts the story ("Small sellers lose X hours a week to dashboards — and half don't know what to do with what they see"); it holds until launch week, then goes to Practical Ecommerce, Handmade Seller Magazine, Craft Industry Alliance + back to the communities that answered.

---

## Deliverable 5 — Local press email (HOLD until launch week)

Find: your city/region's business journal + chamber-of-commerce newsletter + any local founders group. One email each, launch week:
...
| Date | Outlet/show | Type (quote/guest/listing/story) | Link | Notes |
|---|---|---|---|---|
| | | | | |

Related: [[Projects/Welra/Marketing_Campaign_2026-06]] · [[Projects/Welra/Continuation_Playbook]] · press kit: welra.io/press
